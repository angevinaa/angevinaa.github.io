...
fig1 = fig1 %>% layout(title = 'Diversity of Cuisines in NYC Restaurants',
...
cuisine_df = rest_inspec %>% 
  ...
  filter(.data = ., cuisine_description == c("American", "Spanish", "Seafood","Italian","Korean","African","French","Japanese","Mexican","Korean")) %>% 
  na.omit()
...
A heatmap was created to visualize the scores between cuisine and location. The darker cells represent higher violation scores (worse hygiene), and lighter cells represent lower violation scores (better hygiene).
